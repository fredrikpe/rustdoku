...
impl Board {
    ...
    fn insert(&mut self, pos: usize, value: u8) -> bool {
    ...
    fn legal(&self, pos: usize, value: u8) -> bool {
...
struct Cell {
    value: u8, // 0 = blank, 1-9
}
impl Cell {
    fn new(value: u8) -> Cell { Cell { value: value }}
